  ...
  return (
    <div className='p-4'>
        <div className=' bg-gray-500 p-4 pb-6 px-6'>
          <h1 className='text-3xl font-black p-0 text-white border-b-4'>Set/Update Custom Surcharge</h1>
            <div className='mt-4 border-b-2 pb-4'>
                <div className="mt-2">
                    <label className="mt-2 text-white w-40 text-2xl">Member ID</label><br/>
                    <select id="id" onChange={setid} className="bg-gray-50 border border-gray-300  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div className="mt-4">
                    <label className="mt-6 text-white w-40 text-2xl">Service</label><br/>
                    <select id="id" onChange={setid} className="bg-gray-50 border border-gray-300  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              ...
              <div className =" relative overflow-x-auto shadow-md border-black ">    
                <table className=" text-sm text-left rtl:text-right mt-2 border border-black text-gray-500 dark:text-gray-400 border-collapse ">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      ...
                      <th scope="col" className="px-6 py-3 border border-black">Is Package Active</th>                      
                      ...
                      <th scope="col" className="px-6 py-3 border border-black">IS Distributor Available</th>
        ...
        <div classname='flex gap-8'>
                <label className="mt-2 text-white text-2xl">Set Surcharge</label><br />
                <input className=" text-sm px-4 border border-solid border-gray-300 rounded" onChange={(e) => setpack(e.target.value)} type="number" placeholder="Enter Surcharge" />
            </div>

            <div classname='flex gap-8'>
                <label className="mt-2 text-white text-2xl">Set Company</label><br />
                <input className=" text-sm px-4 border border-solid border-gray-300 rounded" onChange={(e) => setcashback(e.target.value)} type="number" placeholder="Enter Start Value" />
            </div>

            <div classname='flex gap-8'>
                <label className="mt-2 text-white text-2xl">Set Distributor</label><br />
                <input className=" text-sm px-4 border border-solid border-gray-300 rounded" onChange={(e) => setdistributor(e.target.value)} type="number" placeholder="Enter Start Value" />
            </div>
...
export default CustomSurcharge
