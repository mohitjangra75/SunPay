...
const Sidebar = () => {
      ...
      return (
        ...
        <div
       className={`bg-blue-800 min-h-screen ${open ? "w-72" : "w-16" } duration-500 text-gray-100 px-4`}>
                ...
                <div  className=" bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul className='list-disc p-2 shadow menu dropdown-content z-[1] text-white ml-4 '>
                                ...
                                <Link to='/admin/change-password'>
                                    <li className='text-black pb-2 hover:text-white hover:bg-gray-700 '>Change password</li>
                                </Link>
