...
const AEPSreport = (props) => {
  ...
  return (
    <div className='p-4'>
      <div className='DMTreport '>
        <div className='bg-slate-300 p-2 border-2 border-red-200'>
          <h1 className=' font-bold text-2xl border-b-2 border-gray-400'>AEPS  REPORT</h1>
        ...
        <h1 className=' font-bold text-2xl border-b-2 border-gray-400'>AEPS TRANSACTIONS</h1>
        ...
        <div className='mt-4'>
          ...
          <div className='mt-4'>
              <div className =" relative overflow-x-auto shadow-md border-black ">
                 <table className="w-full overflow-x-auto text-sm text-left rtl:text-right mt-2 border border-black text-gray-500 dark:text-gray-400 border-collapse ">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      ...
                      {/* last four digit */}
                      <th scope="col" className="px-6 py-3 border border-black">Aadhar No</th>
                      <th scope="col" className="px-6 py-3 border border-black">Transaction Type</th>
{/* CW-Cash withdrawn, BE - Balance enquiry, MS - Mini Statement */}
                      ...
                      <th scope="col" className="px-6 py-3 border border-black">Response</th>
                      {/* response after aeps transaction */}
