      ...
      <div>
        ...
        {!show && (<div>
              ...
              <div className='mt-4 flex gap-4'>
                ...
                <input className=" text-lg px-4 border border-solid border-gray-300 rounded" onChange={(e) => setNumber(e.target.value)} type="text" placeholder="Fee ID/ Enrollment No." />
              </div>
