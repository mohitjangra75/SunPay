...
const Payoutreport = (props) => {
  ...
  return (
    <div>
      <div className='PayoutDMT p-4'>
        <div className='bg-slate-300 p-2 border-2 border-red-200'>
          <h1 className=' font-bold text-2xl border-b-2 border-gray-400'>PAYOUT  SUMMARY</h1>
        ...
        <h1 className=' font-bold text-2xl border-b-2 border-gray-400'>PAYOUT HISTORY</h1>
