    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          const filteredOptions = data.filter(option => option.type === 13);
      ...
      <div>
        <div className='Rechargehistory p-4'>
          <div className='bg-slate-400 w-full p-2 border-2 border-red-200 px-6'>
            <h1 className=' font-bold text-2xl border-b-2 text-white border-gray-400'>Prepaid Recharge</h1>
        ...
        {!show && (<div>
              ...
              <div className='mt-4 flex gap-4'>
                ...
                <input className=" text-lg px-4 border border-solid border-gray-300 rounded" onChange={(e) => setno(e.target.value)} type="number" placeholder="Enter Mobile No" />
              </div>
